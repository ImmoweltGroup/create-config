...
Before opening an issue, please make sure that your issue hasn't been already reported by using the search functionality of the [issue tracker](https://github.com/ImmoweltGroup/create-config/issues).

## Development

Visit the [issue tracker](https://github.com/ImmoweltGroup/create-config/issues) to find a list of open issues that are easy to pick up or need some love.
...
* Open a new issue in the [issue tracker](https://github.com/ImmoweltGroup/create-config/issues).
* Fork the repo.

 ...
 */
function createPathUtils(rootDirPath: string = '/', additionalPathsByKey: AdditionalPathsByKeyType = {}): PathsType {
  ...
  const root: PathFnType = (...args) => Reflect.apply(path.resolve, null, [rootDirPath, ...args]);
